                    ...
                    <div class="product-big-image col-xs-12 col-sm-5 col-lg-5 col-md-5">
                        ...
                        <div class="flexslider flexslider-thumb">
                            <ul class="previews-list slides">
                                <li>
                                    <a href="{{ asset('uploads/'.$product->image) }}" class='cloud-zoom-gallery avatar' rel="useZoom: 'zoom1', smallImage: '{{ asset('uploads/'.$product->image) }}' ">
                    ...
                    <div class="col-xs-12 col-sm-7 col-lg-7 col-md-7 product-details-area">        
                        ...
                        @if(count($sales) !=0)
                            ...
                            @foreach($sales as $sale)
                                <div>
                                    <a href="{{ route('sale') }}">
                                    <img src="{{ asset('uploads/'.$sale->image) }}" alt="" width="100px">
                                    {{ $sale->name }}
                                    <p>
                                        {{ __('form.total') }}: {{ $sale->total }}
                                    </p>
                                    </a>
                                </div>
                            @endforeach
                        ...
                        <div class="col-xs-12">
                            <div class="product-tab-inner"> 
                                <ul id="product-detail-tab" class="nav nav-tabs product-tabs">
                                    ...
                                    <li> 
                                        <a href="#reviews" data-toggle="tab">{{ __('form.rating') }}</a> 
                                    </li>
                                    <li>
                                            ...
                                            <div class="reviews-content-left">
                                                ...
                                                <div class="review-ratting">
                                                    <div class="rating my_rating">
                                                        <h1 class="">{{ (float)$product->rate_avg1() }} <i class="fa fa-star"></i></h1> 
                                                    </div>
                                    ...
                                    <form id="" action="" method="post" >
                                        <div class="form-add-tags">
                                            <div class="input-box">
                                                ...
                                                @endif
                                                @if(Auth::check())
                                                <button type="button" href="{{ route('add-comment', ['id' => $product->id]) }}" class="next-btn next-btn-primary next-btn-medium qna-ask-btn" data-id = "{{ $product->id }}" class="btn_comment">{{ __('home.comment') }}</button>
                                                @else
                                                <a href="{{ route('login') }}">
                                                {{ __('home.message') }}                               
                                                </a>
                                            ...
                                            <div class="comment_parent scroll table_commet">
                                                ...
                                                <div class="media " data-spy="scroll">
                                                    <a class="pull-left" href="#">
                                                        <img class="avatar" src="https://www.gravatar.com/avatar/{{  md5($comment->user->email) }}?s=30" class="user-image" alt="User Image">
                                                    </a>
                                                    ...
                                                    @if (Auth::check())
                                                    <button style="button" class="reply" comment_id = "{{ $comment->id }}"><i class="glyphicon glyphicon-pencil"></i></button>
                                                    @endif    
                                                    <div style="display: none" class="replies{{ $comment->id }} container comment_child{{ $comment->id }}">
                                                        <form action="" method="POST" role="form" class="form-inline container">
                                                            <div class="form-group">
                                                                <textarea placeholder="{{ __('home.reply') }}" rows="5" maxlength="300" type="text" height="100%" data-id="{{ $product->id }}" name="comment" style="border-radius: 20px" class="form-control comment{{ $comment->id }}"></textarea>
                                                            </div>                       

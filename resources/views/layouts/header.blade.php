...
<header>
    <div class="header-container">
        ...
        <div class="row">
            ...
            <!-- Header Logo -->
            <div class="logo">
                <a title="e-commerce" href="{{ route('home') }}"><img alt="e-commerce" src="{{ asset('uploads/logo.png') }}"></a> 
            </div>
            <!-- End Header Logo --> 
            </div>
            ...
            <div data-toggle="dropdown" data-hover="dropdown" class="basket dropdown-toggle"> 
                    ...
                    @if(Cart::count() !=0)
                    <span class="cart-total">{{ Cart::count() }} {{ __('home.product') }}: {{ Cart::subtotal() }} VNĐ</span>
                    @endif
                    </div>
                    </a>
            </div>

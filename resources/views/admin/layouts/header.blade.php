        ...
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">               
                <li class="nav-header">
                    ...
                    <a href="{{ route('admin') }}" class="list-group-item">{{ __('home.admin') }}</a>                    
                <li>
                    <a href="#">    
                ...
                <li>
                    <a href="#"><i class="fa fa-edit"></i> <span class="nav-label">{{ __('admin.code') }}</span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                        <li><a href="{{ route('list-code') }}">{{ __('admin.list', ['name' => trans('admin.code')]) }}</a></li>
                        <li><a href="{{ route('add-code') }}">{{ __('admin.add',['name' => trans('admin.code')]) }}</a></li>
                    </ul>
                </li>
                <li>
                    <a href="#"><i class="fa fa-edit"></i> <span class="nav-label">{{ __('admin.sale') }}</span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                        <li><a href="{{ route('list-sale') }}">{{ __('admin.list', ['name' => trans('admin.sale')]) }}</a></li>
                        <li><a href="{{ route('add-sale') }}">{{ __('admin.add',['name' => trans('admin.sale')]) }}</a></li>
                    </ul>
                </li>
                <li>
                    <a href="#">

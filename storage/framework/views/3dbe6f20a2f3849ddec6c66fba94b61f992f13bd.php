                    ...
                    <ul class="dropdown-menu dropdown-messages">
                        ...
                        <li>
                                ...
                                <div>
                                    ...
                                    Id order  : <?php echo e($order_status->id); ?> 
                                     <?php if($order_status->status == 1): ?>
                                    <label class="label-sm ">Approved</label>
                                    <?php else: ?>
                                    <label class="label-sm ">>Unapproved</label>
                                    <?php endif; ?>
                                    <span class="pull-right text-muted small"><?php echo e(($order_status->created_at)); ?></span>
                                    <div>
                                    <a href="<?php echo e(route('chi-tiet-don-hang',['id'=>$order_status->id])); ?>">Order detail</a>
                                    </div>
                                </div>
                                </a>
                        </li>
                        ...
                        <li>
                            <a href="">
                                <div>
                                    ...
                                    <div>
                                        <a href="<?php echo e(route('chi-tiet-don-hang',['id'=>$order_day->id])); ?>">Order detail</a>
                                    </div>
                                </div>
                            </a>
                        </li>
                ...
                <li>
                    <div class="dropdown profile-element"> 
                        ...
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            <li><a href="<?php echo e(route('ho-so-admin')); ?>">Acount</a></li>
                            <li><a href="">Contacts</a></li>
                            <li><a href="">Mailbox</a></li>
                            <li class="divider"></li>
                            <li><a href="<?php echo e(route('dang-xuat-Admin')); ?>">Logout</a></li>
                        </ul>
                        </a>                        
                     </div>                   
                </li>

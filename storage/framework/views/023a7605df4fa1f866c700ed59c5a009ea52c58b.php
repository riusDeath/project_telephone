    ...
    <div class="panel-body">
        <form action="" method="POST" role="form">
           ...
           <div class="form-group">
               ...
               <input type="text" class="form-control" name="name" placeholder="Tên danh mục" value="<?php echo e($cat->name); ?>" id="name">
            ...
            <div class="form-group">
               ...
               <input type="text" class="form-control" name="slug" placeholder="Đường dẫn tĩnh" id="slug" value="<?php echo e($cat->slug); ?>">

...
<form action="" method="POST" role="form">
	<div class="form-group">
		<label for=""><?php echo e(__('form.created_at')); ?> <?php echo e($order->created_at); ?></label>
	</div>
	<div class="form-group">
		<label for=""><?php echo e(__('form.adress_customer')); ?> <?php echo e($order->adress); ?></label>
	</div>
	<div class="form-group">
		<label><?php echo e(__('form.phone')); ?> <?php echo e($order->phone); ?></label>		
	</div>
	<div class="form-group">
	...
	<a class="btn btn-success" href="<?php echo e(route('login-Admin')); ?>"><?php echo e(__('admin.Approved')); ?> <?php echo e(__('admin.order')); ?></a>
</form>

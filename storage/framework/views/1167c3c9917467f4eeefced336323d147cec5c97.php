...
<div class="panel panel-default">
    <div class="panel-heading"><?php echo e(__('admin.update',['name' => trans('admin.user')])); ?></div>
    <?php if(isset($mess)): ?>
    ...
    <div class="panel-body">
        <form action="" method="POST" role="form">
            ...
            <input type="hidden" name="grade" value="<?php echo e($cus->grade); ?>">
            <div class="form-group">
                <label for=""><?php echo e(__('form.name')); ?></label>
                <input type="text" class="form-control" name="name" placeholder="<?php echo e(__('form.name')); ?>" value="<?php echo e($cus->name); ?>" >
            </div>
            <div class="form-group">
                <label for=""><?php echo e(__('form.adress')); ?></label>
                <input type="text" class="form-control" name="adress" placeholder="<?php echo e(__('form.adress')); ?>" value="<?php echo e($cus->adress); ?>" >
            </div>
            <div class="form-group">
                <label for=""><?php echo e(__('form.email')); ?></label>
                <input type="email" class="form-control" name="email" placeholder="<?php echo e(__('form.email')); ?>" value="<?php echo e($cus->email); ?>" >
            </div>    
            <div class="form-group">
                <label for=""><?php echo e(__('form.phone')); ?></label>
                <input type="number" class="form-control" name="phone" placeholder="<?php echo e(__('form.phone')); ?>" value="<?php echo e($cus->phone); ?>" >
            </div>        
            <div class="form-group">
                <label for="">

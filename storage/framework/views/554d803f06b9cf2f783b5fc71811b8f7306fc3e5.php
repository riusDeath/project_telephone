            ...
            <div class="slider-items-products">
              <div id="category-desc-slider" class="product-flexslider hidden-buttons">
                <div class="slider-items slider-width-col1 owl-carousel owl-theme"> 
                  ...
                  <!-- Item -->
                  <div class="item"> <a href="#x"><img alt="" src="<?php echo e(asset('uploads/cat-slider-img1.jpg')); ?>"></a>
                  ...
                  <!-- Item -->
                  <div class="item"> <a href="#x"><img alt="" src="<?php echo e(asset('uploads/cat-slider-img2.jpg')); ?>"></a> </div>
                  ...
                  <div class="product-item">
                    <div class="item-inner">
                      <div class="product-thumbnail">
                        ...
                        <div class="pr-img-area"> <a title="Ipsums Dolors Untra" href="<?php echo e(route('home-chi-tiet-san-pham',['id' => $product->id])); ?>">
                          <div> <img class="first-img" src="<?php echo e(asset('uploads/'.$product->image)); ?>" alt=""> <img class="hover-img" src="<?php echo e(asset('uploads/'.$product->image)); ?>" alt=""></div>
                          </a>
                        ...
                        <div class="info-inner">
                          ...
                          <div class="item-content">
                            ...
                            <div class="item-price">
                              <div class="price-box"> <span class="regular-price"> <span class="price"><?php echo e($product->price_sale==0?number_format($product->price):number_format($product->price_sale)); ?> VND</span> </span> </div>
                            </div>
                          </div>
                        </div>
                      </div>
        ...
        <aside class="sidebar col-sm-3 col-xs-12 col-sm-pull-9">
                ...
                <div class="layered-content">
                  <ul class="check-box-list">
                    ...
                    <li>
                     ...
                     <!--  <input type="checkbox" id="jtv1" name="category_id"  value="<?php echo e($parent->id); ?>"> -->
                      <label for="jtv1"> <span class="button"></span> <?php echo e($parent->name); ?><span class="count">(12)</span> </label>
                     </a>
                    </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </ul>
              ...
              <div class="manufacturer-area">
                ...
                <div class="saide-bar-menu">
                  <ul>
                    ...
                    <li><a href="<?php echo e(route('san-pham-thuong-hieu',['brand_id' => $brand->id])); ?>">&nbsp; <i class="fa fa-angle-right"></i><?php echo e($brand->name); ?></a></li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </ul>
                </div>
              </div>
            ...
            <div class="block-content">
              <div class="slider-range">
                ...
                <form action="<?php echo route('san-pham-theo-gia'); ?>" method="POST" enctype="multipart/form-data">
                  ...
                  <input type="hidden" value="15000" name="price_old">
                  <input type="hidden" value="500000" name="price_new">
                  <ul class="check-box-list">
                    <li>
                      <input type="checkbox" id="p1" name="checkbox"/>
                      <label for="p1"> <span class="button"></span> $20 - $50<span class="count">(0)</span> </label>
                    </li>
                    <li>
                      <input type="checkbox" id="p2" name="checkbox" />
                      <label for="p2"> <span class="button"></span> $50 - $100<span class="count">(0)</span> </label>
                    </li>
                    <li>
                      <input type="checkbox" id="p3" name="checkbox" />
                      <label for="p3"> <span class="button"></span> $100 - $250<span class="count">(0)</span> </label>
                    </li>
                  </ul>
                  <button type="submit" class="btn btn-primary text-right">Tìm kiếm</button>
                </form>
              </div>
            </div>
          </div>
          ...
          <div class="block sidebar-cart">
            ...
            <div class="block-content">
              ...
              <ul>
                <li class="item"> <a href="shopping_cart.html" title="Sample Product" class="product-image"><img src="img07.jpg" alt="Sample Product "></a>
                ...
                <li class="item last"> <a href="#" title="Sample Product" class="product-image"><img src="img08.jpg" alt="Sample Product"></a>
                  <div class="product-details">
                    <div class="access"> <a href="#" title="Remove This Item" class="remove-cart"><i class="icon-close"></i></a></div>
          ...
          <div class="single-img-add sidebar-add-slider ">
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel"> 
              ...
              <div class="carousel-inner" role="listbox">
                ...
                <div class="item"> <img src="<?php echo e(asset('uploads/add-slide2.jpg')); ?>" alt="slide2">
                  <div class="carousel-caption">
                    <h3><a href="single_product.html" title=" Sample Product">Smartwatch Collection</a></h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                    <a href="#" class="info">All Collection</a> </div>
                </div>
                <div class="item"> <img src="<?php echo e(asset('uploads/add-slide3.jpg')); ?>" alt="slide3">
                  <div class="carousel-caption">
          ...
          <div class="block special-product">
            ...
            <div class="block-content">
              <ul>
                ...
                <li class="item">
                  <div class="products-block-left"> <a href="single_product.html" title="Sample Product" class="product-image"><img src="img01.jpg" alt="Sample Product "></a></div>
                ...
                <!-- <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> -->
                <li class="item">
                  <div class="products-block-left"> <a href="single_product.html" title="Sample Product" class="product-image"><img src="img02.jpg" alt="Sample Product "></a></div>
                  <div class="products-block-right">

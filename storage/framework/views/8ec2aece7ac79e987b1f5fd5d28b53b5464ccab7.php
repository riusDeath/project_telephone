        ...
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">               
                <li class="nav-header">
                    ...
                    <a href="<?php echo e(route('admin')); ?>" class="list-group-item"><?php echo e(__('home.admin')); ?></a>                    
                <li>
                    <a href="#">    
                ...
                <li>
                    <a href="#"><i class="fa fa-edit"></i> <span class="nav-label"><?php echo e(__('admin.code')); ?></span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                        <li><a href="<?php echo e(route('list-code')); ?>"><?php echo e(__('admin.list', ['name' => trans('admin.code')])); ?></a></li>
                        <li><a href="<?php echo e(route('add-code')); ?>"><?php echo e(__('admin.add',['name' => trans('admin.code')])); ?></a></li>
                    </ul>
                </li>
                <li>
                    <a href="#"><i class="fa fa-edit"></i> <span class="nav-label"><?php echo e(__('admin.sale')); ?></span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                        <li><a href="<?php echo e(route('list-sale')); ?>"><?php echo e(__('admin.list', ['name' => trans('admin.sale')])); ?></a></li>
                        <li><a href="<?php echo e(route('add-sale')); ?>"><?php echo e(__('admin.add',['name' => trans('admin.sale')])); ?></a></li>
                    </ul>
                </li>
                <li>
                    <a href="#">

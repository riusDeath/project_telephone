...
<header>
    <div class="header-container">
        ...
        <div class="row">
            ...
            <!-- Header Logo -->
            <div class="logo">
                <a title="e-commerce" href="<?php echo e(route('home')); ?>"><img alt="e-commerce" src="<?php echo e(asset('uploads/logo.png')); ?>"></a> 
            </div>
            <!-- End Header Logo --> 
            </div>
            ...
            <div data-toggle="dropdown" data-hover="dropdown" class="basket dropdown-toggle"> 
                    ...
                    <?php if(Cart::count() !=0): ?>
                    <span class="cart-total"><?php echo e(Cart::count()); ?> <?php echo e(__('home.product')); ?>: <?php echo e(Cart::subtotal()); ?> VNĐ</span>
                    <?php endif; ?>
                    </div>
                    </a>
            </div>

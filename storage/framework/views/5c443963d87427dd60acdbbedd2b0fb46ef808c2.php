    ...
    <div class="container">
            ...
            <div class="shop-inner">
                ...
                <div class="toolbar">
                    ...
                    <div class="sorter">
                        ...
                        <select  class="mysortok" duong-dan="<?php echo e(url('/')); ?>/product/sap-xep-san-pham/" width="auto">
                                ...
                                <div class="item-inner">
                                    <div class="product-thumbnail">
                                        ...
                                        <div class="pr-img-area"> 
                                            ...
                                            <?php if(Auth::check()): ?>
                                            <span>
                                                <a class="add-to-cart-mt"  href="<?php echo e(route('add_cart',['id' => $product->id])); ?>" >
                                                <i class="fa fa-shopping-cart"> </i><?php echo e(__('home.add_to_cart')); ?></a>
                                            </span>   
                                            <?php endif; ?>                                  
                                        </div>
        ...
        <aside class="sidebar col-sm-3 col-xs-12 col-sm-pull-9">
            ...
            <div class="block-content">
                ...
                <h2 class="saider-bar-title"><?php echo e(__('admin.category')); ?></h2>
                <div class="layered-content">
                    <ul class="check-box-list">
                        ...
                        <li>
                            <a href="<?php echo e(route('product_category',['category_id' => $parent->id])); ?>">
                ...
                <h2 class="saider-bar-title"><?php echo e(__('admin.brand')); ?></h2>
                <div class="saide-bar-menu">
                    <ul>
                        <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                            <a href="<?php echo e(route('product_brand',['brand_id' => $brand->id])); ?>">&nbsp; 
        ...
        <div class="block product-price-range ">
            ...
            <div class="block-content">
                <div class="slider-range">
                <form action="<?php echo e(route('product_start')); ?>" method="get" role="form">
        ...
        <div class="mini-cart-list">
            ...
            <div class="sidebar-bar-title">
                <h3><?php echo e(__('home.my_order')); ?></h3>
            </div>
            <div class="block-content">
                <p class="amount"><?php echo e(__('form.total')); ?> <a href="shopping_cart.html"><?php echo e(Cart::count()); ?></a> sản phẩm.</p>
                <ul>
                    ...
                    <li class="item"> 
                        ...
                        <div class="access"> 
                            <a href="<?php echo e(route('deleteCart',['rowId' => $cart->rowId])); ?>" title="Xóa sản phẩm ra khỏi giỏ hàng" class="" onclick="confirm('Bạn muốn xóa sản phẩm <?php echo e($cart->name); ?> ra khỏi giỏ hàng?')">
                                <i class="fa fa-trash-o"><?php echo e(__('form.delete')); ?></i>
                            </a>
                        </div>
                        </div> 
                    </li>
                    ...
                    <div class="summary">
                        <p class="subtotal"> 
                            <span class="label"><?php echo e(__('form.subtotal')); ?>:</span> <span class="price"><?php echo e(Cart::subtotal()); ?></span> 
                        </p>
                    </div>
                    <div class="cart-checkout">
                        <a class="view-cart" href="<?php echo e(route('viewOrder')); ?>">
                            <i class="fa fa-shopping-cart"></i> <span><?php echo e(__('home.view_order')); ?></span>
                        </a>
                        <a class="button button-checkout" title="Submit" href="<?php echo e(route('checkout')); ?>">
  ...
  <script type="text/javascript" >
     $(document).ready(function(){
        $(document).on('click', '.add-to-cart-mt', function(e){
            e.preventDefault();
            var add = confirm('<?php echo e(trans('home.add_cart')); ?>');
            if (add) {
